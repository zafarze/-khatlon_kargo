...
TEXTS = {
    "ru": {
        ...
        "select_region": "Пожалуйста, выберите ваш филиал (Регион):",
        "region_selected": "Филиал установлен: {region}",
        "region_bokhtar": "Бохтар",
        "region_qubodiyon": "Кабодиён",
        ...
        "track_code_found_yiwu": (
            "Ассалому алейкум!\n"
            "✅ Ваш груз с трек-кодом <b>{code}</b> принят на складе Khatlon Kargo в г. Иу.\n"
            "🗓️ <b>Дата приёма:</b> {date}\n"
            "⏳ Срок доставки: 15-25 дней. Постараемся доставить Ваш груз раньше срока.\n\n"
            "✨ Khatlon Kargo! Надежное, быстрое карго по доступной цене."
        ),

        "track_code_found_dushanbe": (
            "Ассалому алейкум!\n"
            "🚚 Ваш груз с трек-кодом <b>{code}</b> прибыл на склад Khatlon Kargo в г. Душанбе!\n"
            "🗓️ <b>Дата прибытия:</b> {date}\n\n"
            "📞 Пожалуйста, свяжитесь с нами для получения груза: <code>+992936005303</code>.\n\n"
            "✨ Khatlon Kargo! Надежное, быстрое карго по доступной цене."
        ),
        "track_code_not_found": "❌ Ваш груз пока не поступил на склад Khatlon Kargo в г. Иу.",
        ...
        "dushanbe_arrival_notification": (
            "🚚 Уважаемый клиент!\n"
            "Ваш груз с трек-кодом '{code}' прибыл на склад Khatlon Kargo в г. Душанбе!\n"
            "📞 Пожалуйста, свяжитесь с нами для получения груза: +992 93 600 53 03."
        ),
        "contacts": (
            "Khatlon Kargo\n"
            ...
            "Инстаграм: https://www.instagram.com/khatlonkargo\n"
            "Телеграм: https://t.me/khatlon_cargo"
        ),
        "prices_text": (
            "Наши тарифы из Китая:\n\n"
            "🚚 30 сомон/кг\n\n"
        ...
        "address_caption_tajikistan": (
            ...
            "район Сино, ул. Дилкушо 26/1\n"
            "(Ориентир: рынок Джал-Джам)\n\n"
            "📞 Телефон: +992 93 600 53 03"
        ),
        ...
        "help_message": (
            "👋 Здравствуйте! Я бот Khatlon Kargo.\n\n"
        ...
        # --- БЛОК ДЛЯ ПОДПИСКИ ---
        "subscribe_prompt": "Чтобы продолжить, пожалуйста, подпишитесь на наш канал: @khatlon_cargo",
        "subscribe_button_channel": "Khatlon Kargo",
    ...
    "en": {
        ...
        "select_region": "Please select your branch (Region):",
        "region_selected": "Branch set to: {region}",
        "region_bokhtar": "Bokhtar",
        "region_qubodiyon": "Qubodiyon",
        ...
        "track_code_found_yiwu": (
            "Assalomu alaykum!\n"
            "✅ Your cargo with track code <b>{code}</b> has been received at the Khatlon Kargo warehouse in Yiwu city.\n"
            "🗓️ <b>Date of acceptance:</b> {date}\n"
            "⏳ Delivery time: 15-25 days. We will try to deliver your cargo ahead of schedule.\n\n"
            "✨ Khatlon Kargo! Reliable, fast cargo at an affordable price."
        ),

        "track_code_found_dushanbe": (
            "Assalomu alaykum!\n"
            "🚚 Your cargo with track code <b>{code}</b> has arrived at the Khatlon Kargo warehouse in Dushanbe!\n"
            "🗓️ <b>Date of arrival:</b> {date}\n\n"
            "📞 Please contact us to pick up your cargo: <code>+992936005303</code>.\n\n"
            "✨ Khatlon Kargo! Reliable, fast cargo at an affordable price."
        ),
        "track_code_not_found": "❌ Your cargo has not yet arrived at the Khatlon Kargo warehouse in Yiwu.",
        "track_code_found_other": (
        ...
        "dushanbe_arrival_notification": (
            "🚚 Dear Customer!\n"
            "Your cargo with track code '{code}' has arrived at the Khatlon Kargo warehouse in Dushanbe!\n"
            "📞 Please contact us to pick up your cargo: +992 93 600 53 03."
        ),
        "contacts": (
            "Khatlon Kargo\n"
            ...
            "Instagram: https://www.instagram.com/khatlonkargo\n"
        ...
        "address_caption_tajikistan": (
            ...
            "26/1 Dilkusho Street, Sino district\n"
            "(Landmark: Jal-jam market)\n\n"
            "📞 Phone: +992 93 600 53 03"
        ),
        ...
        # --- SUBSCRIPTION BLOCK ---
        "subscribe_prompt": "To continue, please subscribe to our channel: @khatlon_cargo",
        "subscribe_button_channel": "Khatlon Kargo",
    ...
    "tg": {
        ...
        "select_region": "Лутфан филиали худро (Минтақа) интихоб кунед:",
        "region_selected": "Филиал интихоб шуд: {region}",
        "region_bokhtar": "Бохтар",
        "region_qubodiyon": "Қубодиён",
        ...
        "track_code_found_yiwu": (
            "Ассалому алайкум!\n"
            "✅ Бори шумо бо трек-коди <b>{code}</b> дар анбори Khatlon Kargo дар ш. Иву қабул карда шуд.\n"
            "🗓️ <b>Санаи қабул:</b> {date}\n"
            "⏳ Мӯҳлати тахминии расонидан: 15-25 рӯз. Мо кӯшиш мекунем, ки бори Шуморо пеш аз мӯҳлат расонем.\n\n"
            "✨ Khatlon Kargo! Каргои боэтимод, зуд ва бо нархи дастрас."
        ),

        "track_code_found_dushanbe": (
            "Ассалому алайкум!\n"
            "🚚 Бори шумо бо трек-коди <b>{code}</b> ба анбори Khatlon Kargo дар ш. Душанбе расид!\n"
            "🗓️ <b>Санаи расидан:</b> {date}\n\n"
            "📞 Лутфан барои гирифтани бор бо мо тамос гиред: <code>+992936005303</code>.\n\n"
            "✨ Khatlon Kargo! Каргои боэтимод, зуд ва бо нархи дастрас."
        ),
        "track_code_not_found": "❌ Бори Шумо то ҳол дар анбори Khatlon Kargo дар ш. Иву наомадааст.",
        "track_code_found_other": (
        ...
        "dushanbe_arrival_notification": (
            "🚚 Мизоҷи муҳтарам!\n"
            "Бори шумо бо трек-коди '{code}' ба анбори Khatlon Kargo дар ш. Душанбе расид!\n"
            "📞 Лутфан барои гирифтани бор бо мо тамос гиред: +992 93 600 53 03."
        ),
        "contacts": (
            "Khatlon Kargo\n"
            "Вақти корӣ: аз 9:00 то 17:00\n"
            "Танаффус: аз 12:00 то 13:00\n\n"
            "📞 Телефон: <code>{phone}</code>\n"
            "Инстаграм: https://www.instagram.com/khatlonkargo\n"
            "Телеграм: https://t.me/khatlon_cargo"
        ),
        ...
        "address_caption_tajikistan": (
            ...
            "Кӯчаи Дилкушо, 26/1, ноҳияи Сино\n"
            "(Нишона: бозорчаи Ҷал-ҷам)\n\n"
            "📞 Телефон: +992 93 600 53 03"
        ),
        ...
        "help_message": (
            "👋 Ассалому алайкум! Ман боти Khatlon Kargo.\n\n"
        ...
        # --- БЛОК ДЛЯ ПОДПИСКИ ---
        "subscribe_prompt": "Барои идома, лутфан ба канали мо обуна шавед: @khatlon_cargo",
        "subscribe_button_channel": "Khatlon Kargo",
...
def get_text(key, lang='ru'):
    ...
    """
    selected_texts = TEXTS.get(lang, TEXTS.get('ru', {}))
    ...
    # Fallback: Если текста нет, возвращаем русский
    if lang != 'ru':
        text_ru = TEXTS.get('ru', {}).get(key)
        if text_ru:
            return text_ru

    # Если вообще нигде нет
